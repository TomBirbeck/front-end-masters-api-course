        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                updates = products.reduce(function (allUpdates, product) {
                    return __spreadArray(__spreadArray([], allUpdates, true), [product.updates], false);
                }, []);
...
var updateUpdate = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var products, updates, match, updatedUpdate, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
...
var deleteUpdate = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var products, updates, match, deleted, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
